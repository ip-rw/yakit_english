...
const BatchVulnerabilityDetection = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_2812_7504)'>
            ...
            <circle cx='8' cy='14' r='2' fill='white' stroke='#f28b44' strokeWidth='1.5' />
            <circle cx='17' cy='15' r='1' fill='white' stroke='#f28b44' strokeWidth='1.5' />
            <circle cx='19' cy='5' r='1' fill='white' stroke='#f28b44' strokeWidth='1.5' />
        </g>
    </svg>
)
...
const ExtraCodec = () => (
    <svg width='20' height='20' viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path d='M7.61411 11.188L7.6131 11.1868L7.92792 10.94L7.6151 11.1893L7.61411 11.188Z' fill='currentColor' />
        <path d='M7.639 6.55484L7.64004 6.55355L7.95192 6.804L7.63797 6.55614L7.639 6.55484Z' fill='currentColor' />
        <path
            fillRule='evenodd'
            clipRule='evenodd'
 ...
 */
export const ExtraMenuCodecIcon = (props: Partial<CustomIconComponentProps>) => {
    return <Icon component={ExtraCodec} {...props} />
}
...
const CVE = () => (
    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fillRule="evenodd" clipRule="evenodd" d="M34 37H10C9.44772 37 9 36.5523 9 36V8C9 7.44772 9.44772 7 10 7H27.5V12C27.5 13.3807 28.6193 14.5 30 14.5H35V36C35 36.5523 34.5523 37 34 37ZM36 13.5V14.5V36C36 37.1046 35.1046 38 34 38H10C8.89543 38 8 37.1046 8 36V8C8 6.89543 8.89543 6 10 6H27.5H28.5H28.5049C29.0353 6 29.544 6.21071 29.9191 6.58579L35.4142 12.0809L34.7071 12.788L29.212 7.29289C29.0245 7.10536 28.7701 7 28.5049 7H28.5V12C28.5 12.8284 29.1716 13.5 30 13.5H35V13.4951C35 13.2299 34.8946 12.9755 34.7071 12.788L35.4142 12.0809C35.7893 12.456 36 12.9647 36 13.4951V13.5Z" fill="#31343F" />
        <path fillRule="evenodd" clipRule="evenodd" d="M12.5 14C12.5 13.7239 12.7239 13.5 13 13.5H19C19.2761 13.5 19.5 13.7239 19.5 14C19.5 14.2761 19.2761 14.5 19 14.5H13C12.7239 14.5 12.5 14.2761 12.5 14Z" fill="#31343F" />
